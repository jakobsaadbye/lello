    ...
    return (
        <div className="relative h-dvh p-8 bg-sky-600 overflow-hidden">
            <div className='flex flex-col h-full px-4'>
                <ControlBar boardId={id} className="absolute ml-8 mt-8" />
                <header className='flex w-full justify-center items-center text-center pb-8'>
                    <input
                        className='ml-32 mb-8 text-5xl text-white font-bold bg-transparent'
                        value={board.title}
                        maxLength={32}
